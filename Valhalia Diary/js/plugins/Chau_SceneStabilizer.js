/*:
@author Chaucer
@plugindesc | Scene Stabilizer : Version - 5.4.1 | Stabilizes scenes on scene change.
@help
===============================================================================
 Introduction :
===============================================================================
...
//-----------------------------------------------------------------------------
  ...
  var length = assets.length;
  for (var i = 0; i < length; i++) {
    if ( assets[i].endsWith( extensionType ) ) {
      this.preloadAsset( key + ':' + assets[i].replace( ext, '' ) );
    }
  }
};
